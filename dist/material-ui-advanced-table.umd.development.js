(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@material-ui/core'), require('prop-types'), require('react-beautiful-dnd'), require('@date-io/date-fns'), require('@material-ui/pickers'), require('@material-ui/core/styles/colorManipulator'), require('classnames'), require('filefy'), require('react-double-scrollbar'), require('date-fns/format'), require('debounce')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@material-ui/core', 'prop-types', 'react-beautiful-dnd', '@date-io/date-fns', '@material-ui/pickers', '@material-ui/core/styles/colorManipulator', 'classnames', 'filefy', 'react-double-scrollbar', 'date-fns/format', 'debounce'], factory) :
  (global = global || self, factory(global['material-ui-advanced-table'] = {}, global.React, global.core, global.PropTypes, global.reactBeautifulDnd, global.DateFnsUtils, global.pickers, global.colorManipulator, global.classNames, global.filefy, global.DoubleScrollbar, global.formatDate, global.debounce));
}(this, function (exports, React, core, PropTypes, reactBeautifulDnd, DateFnsUtils, pickers, colorManipulator, classNames, filefy, DoubleScrollbar, formatDate, debounce) { 'use strict';

  React = React && React.hasOwnProperty('default') ? React['default'] : React;
  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  DateFnsUtils = DateFnsUtils && DateFnsUtils.hasOwnProperty('default') ? DateFnsUtils['default'] : DateFnsUtils;
  classNames = classNames && classNames.hasOwnProperty('default') ? classNames['default'] : classNames;
  DoubleScrollbar = DoubleScrollbar && DoubleScrollbar.hasOwnProperty('default') ? DoubleScrollbar['default'] : DoubleScrollbar;
  formatDate = formatDate && formatDate.hasOwnProperty('default') ? formatDate['default'] : formatDate;
  ...
  core.withStyles(styles)(MTableHeader);
  ...
  core.withStyles(styles$1)(MTableToolbar);
  ...
  function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      }, React.createElement(core.LinearProgress, null))), this.renderFooter(), (this.state.isLoading || props.isLoading) && props.options.loadingType === 'overlay' && React.createElement("div", {
        style: {
          position: 'absolute',
          top: 0,
          left: 0,
  ...
  exports.MTableSteppedPagination = MTablePagination$1;
  exports.MTableToolbar = mTableToolbar;
  exports.default = index;

}));
//# sourceMappingURL=material-ui-advanced-table.umd.development.js.map
