...
import { IconButton, Icon, Tooltip, TableRow, TableCell, TableBody, Checkbox, Toolbar, Typography, Chip, Select, MenuItem, TextField, FormControl, InputLabel, Input, ListItemText, InputAdornment, withStyles, TableSortLabel, TableHead, createStyles, Button, Hidden, Menu, FormControlLabel, TablePagination, CircularProgress, Paper, Table, TableFooter, LinearProgress } from '@material-ui/core';
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var button = React.createElement(IconButton, {
    ...
    }, typeof action.icon === 'string' ? React.createElement(Icon, Object.assign({}, action.iconProps), action.icon) : React.createElement(action.icon, Object.assign({}, action.iconProps, {
      disabled: action.disabled
    })));
...
function (_React$Component) {
  ...
  _proto.renderEmpty = function renderEmpty(emptyRowCount, renderData) {
    ...
    if (this.props.options.showEmptyDataSourceMessage && renderData.length === 0) {
      ...
      }), emptyRowCount > 0 && React.createElement(TableRow, {
        style: {
          height: 1
        },
        key: 'empty-last1'
  ...
  _proto.render = function render() {
    ...
    return React.createElement(TableBody, null, this.props.options.filtering && React.createElement(this.props.components.FilterRow, {
  ...
  _proto.renderDetailPanelColumn = function renderDetailPanelColumn() {
    ...
    if (typeof this.props.detailPanel == 'function') {
      ...
      return React.createElement(TableCell, {
        ...
        if (panel.tooltip) {
          iconButton = React.createElement(Tooltip, {
            key: 'key-detail-panel-' + index,
            title: panel.tooltip
          }, iconButton);
        }
  ...
  _proto.render = function render() {
    ...
    if (this.props.isTreeData) {
      if (this.props.data.tableData.childRows && this.props.data.tableData.childRows.length > 0) {
        renderColumns.splice(0, 0, React.createElement(TableCell, {
          padding: "none",
    ...
    }), this.props.data.tableData && this.props.data.tableData.showDetailPanel && React.createElement(TableRow, null, React.createElement(TableCell, {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(Toolbar, {
      ...
      return React.createElement("div", {
      ...
      }, _this2.props.groupColumns.length > 0 && React.createElement(Typography, {
        variant: "caption",
        style: {
          padding: 8
        }
        ...
        return React.createElement(Draggable, {
          ...
          }), React.createElement(Chip, Object.assign({}, provided.dragHandleProps, {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    for (var i = 0; i < this.props.level; i++) {
      freeCells.push(React.createElement(TableCell, {
        padding: "checkbox",
        key: i
      }));
    }
    ...
    return React.createElement(React.Fragment, null, React.createElement(TableRow, null, freeCells, React.createElement(this.props.components.Cell, {
      colSpan: colSpan,
      padding: "none",
      columnDef: column,
      value: value,
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (this.props.mode === 'add' || this.props.mode === 'update') {
      ...
      columns = [React.createElement(TableCell, {
    ...
    if (this.props.detailPanel) {
      ...
      columns.splice(index, 0, React.createElement(TableCell, {
        padding: "none",
    ...
    return React.createElement(React.Fragment, null, React.createElement(TableRow, Object.assign({}, rowProps, {
      style: this.getStyle()
    }), columns));
  };
...
function (_React$Component) {
  ...
  _proto.renderLookupField = function renderLookupField() {
    ...
    return React.createElement(Select, Object.assign({}, this.getProps(), {
  ...
  _proto.renderBooleanField = function renderBooleanField() {
    ...
    return React.createElement(Checkbox, Object.assign({}, this.getProps(), {
  ...
  _proto.renderDateField = function renderDateField() {
    return React.createElement(MuiPickersUtilsProvider, {
      utils: DateFnsUtils
    }, React.createElement(DatePicker, Object.assign({}, this.getProps(), {
      format: "dd.MM.yyyy",
  ...
  _proto.renderTimeField = function renderTimeField() {
    return React.createElement(MuiPickersUtilsProvider, {
      utils: DateFnsUtils
    }, React.createElement(TimePicker, Object.assign({}, this.getProps(), {
      format: "HH:mm:ss",
      value: this.props.value || null,
      onChange: this.props.onChange,
      clearable: true,
  ...
  _proto.renderDateTimeField = function renderDateTimeField() {
    return React.createElement(MuiPickersUtilsProvider, {
      utils: DateFnsUtils
    }, React.createElement(DateTimePicker, Object.assign({}, this.getProps(), {
  ...
  _proto.renderTextField = function renderTextField() {
    ...
    return React.createElement(TextField, Object.assign({}, this.getProps(), {
...
function (_React$Component) {
  ...
  function MTableFilterRow() {
    ...
    _this.renderLookupFilter = function (columnDef) {
      ...
      }, columnDef.filterPlaceholder), React.createElement(Select, {
        multiple: true,
  ...
  _proto.render = function render() {
    ...
    if (this.props.emptyCell && this.props.hasActions) {
      if (this.props.actionsColumnIndex === -1) {
        ...
        columns.splice(this.props.actionsColumnIndex + endPos, 0, React.createElement(TableCell, {
          key: "key-action-column"
        }));
      }
    }
...
function (_React$Component) {
  ...
  _proto.renderHeader = function renderHeader() {
    ...
    var mapArr = this.props.columns.filter(function (columnDef) {
      ...
      if (_this.props.draggable) {
        content = React.createElement(Draggable, {
          key: columnDef.tableData.id,
          draggableId: columnDef.tableData.id.toString(),
          index: index
        }, function (provided) {
      ...
      if (columnDef.sorting !== false && _this.props.sorting) {
        content = React.createElement(TableSortLabel, {
  ...
  _proto.renderSelectionHeader = function renderSelectionHeader() {
    ...
    return React.createElement(TableCell, {
      ...
      className: this.props.classes.header,
      style: _extends({}, this.props.headerStyle)
    }, this.props.showSelectAllCheckbox && React.createElement(Checkbox, {
  ...
  _proto.render = function render() {
    ...
    if (this.props.isTreeData > 0) {
      headers.splice(0, 0, React.createElement(TableCell, {
        padding: "none",
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, showFirstLastPageButtons && React.createElement(Tooltip, {
      title: localization.firstTooltip
    }, React.createElement("span", null, React.createElement(IconButton, {
      onClick: this.handleFirstPageButtonClick,
      disabled: page === 0,
      "aria-label": localization.firstAriaLabel
    }, theme.direction === 'rtl' ? React.createElement(this.props.icons.LastPage, null) : React.createElement(this.props.icons.FirstPage, null)))), React.createElement(Tooltip, {
      title: localization.previousTooltip
    }, React.createElement("span", null, React.createElement(IconButton, {
      onClick: this.handleBackButtonClick,
      disabled: page === 0,
      "aria-label": localization.previousAriaLabel
    }, theme.direction === 'rtl' ? React.createElement(this.props.icons.NextPage, null) : React.createElement(this.props.icons.PreviousPage, null)))), React.createElement(Typography, {
      variant: "caption",
      style: {
        flex: 1,
        textAlign: 'center',
    ...
    }, localization.labelDisplayedRows.replace('{from}', this.props.page * this.props.rowsPerPage + 1).replace('{to}', Math.min((this.props.page + 1) * this.props.rowsPerPage, this.props.count)).replace('{count}', this.props.count)), React.createElement(Tooltip, {
      title: localization.nextTooltip
    }, React.createElement("span", null, React.createElement(IconButton, {
      onClick: this.handleNextButtonClick,
      disabled: page >= Math.ceil(count / rowsPerPage) - 1,
      "aria-label": localization.nextAriaLabel
    }, theme.direction === 'rtl' ? React.createElement(this.props.icons.PreviousPage, null) : React.createElement(this.props.icons.NextPage, null)))), showFirstLastPageButtons && React.createElement(Tooltip, {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", {
      ...
      disabled: page === 0,
      "aria-label": localization.previousAriaLabel
    }, React.createElement(this.props.icons.PreviousPage, null)))), React.createElement(Hidden, {
      smDown: true
    }, this.renderPagesButton(pageStart, pageEnd)), React.createElement(Tooltip, {
      title: localization.nextTooltip
    }, React.createElement("span", null, React.createElement(IconButton, {
      onClick: this.handleNextButtonClick,
...
function (_React$Component) {
  ...
  function MTableToolbarInner(props) {
    ...
    _this.defaultExportCsv = function () {
      ...
      var builder = new CsvBuilder((_this.props.exportFileName || _this.props.title || 'data') + '.csv');
  ...
  _proto.renderDefaultActions = function renderDefaultActions() {
    ...
    }, React.createElement(this.props.icons.ViewColumn, null))), React.createElement(Menu, {
    ...
    }, React.createElement(this.props.icons.Export, null))), React.createElement(Menu, {
...
function (_React$Component) {
  ...
  function MaterialTable(props) {
    ...
    _this.onSearchChangeDebounce = debounce(function () {
    ...
    _this.onFilterChangeDebounce = debounce(function () {
      if (_this.isRemoteData()) {
        var query = _extends({}, _this.state.query);
  ...
  _proto.renderFooter = function renderFooter() {
    ...
    if (props.options.paging) {
      ...
      return React.createElement(Table, null, React.createElement(TableFooter, {
        style: {
          display: 'grid'
        }
      }, React.createElement(TableRow, null, React.createElement(props.components.Pagination, {
        classes: {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(DragDropContext, {
      ...
      }, React.createElement(Table, null, props.options.header && React.createElement(props.components.Header, {
    ...
    }, React.createElement(LinearProgress, null))), this.props.preFooterRow && this.props.preFooterRow, this.renderFooter(), (this.state.isLoading || props.isLoading) && props.options.loadingType === 'overlay' && React.createElement("div", {
      style: {
        position: 'absolute',
        top: 0,
        left: 0,
