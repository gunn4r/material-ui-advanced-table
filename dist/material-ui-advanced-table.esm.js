...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, React.createElement(LinearProgress, null))), this.props.preFooterRow, this.renderFooter(), (this.state.isLoading || props.isLoading) && props.options.loadingType === 'overlay' && React.createElement("div", {
      style: {
        position: 'absolute',
        top: 0,
        left: 0,
